...
-- Hàm mã hóa Base64 (có thể dùng ngoài game)
...
local function getWebhook(name)
	local encoded = EncodedWebhookTable[name]
	if encoded then
...
function sendBossWebhook(eventName, swordName)
    ...
    embeds = {{
        ...
        image = {
            url = "https://cdn.discordapp.com/attachments/1387638319587786772/1396703388774830132/IMG_2411.png?ex=687f0ce5&is=687dbb65&hm=31db1f5c2fe7f3a1de1ab363bbc92058637d5351378b2429ad7bece8d980c17d&" -- Thay URL này bằng link ảnh public Discord hoặc từ website của bạn
        },
        footer = {
